...
import { Container, Faq, FaqAnswer, FaqHeader, FaqQuestion, FaqsSection, LeftSection, MinusIcon, PlusIcon, Section } from './FAQ.styled';
...
FaqLayout.Header = function FaqLayoutHeader({children,...restProps}) {
    ...
    return(
        <FaqHeader {...restProps}>{children}</FaqHeader>
    )
}
