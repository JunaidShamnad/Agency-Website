...
import { Heading,Hero,HeroDescription,HeroButtons,ImageContainer,Image ,ImageBelow } from "./HeroSection.styled"
...
const HeroSection = () => {
    return (
      ...
      <Hero>
        ...
        <Heading>IT'S TIME TO PURSUR BETTER FUTURE</Heading>
