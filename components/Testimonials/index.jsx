  ...
  return (
    <>
      <Container>
        <UpperTestimonial>
          <TestimonialsTitle>
            <SpanTitle>Testimonial</SpanTitle>Client's Kind Word
          </TestimonialsTitle>
          <TestimonialsDescription>
        ...
        <LowerTestimonial>
          ...
          <TestimonialContentSection>
          <TestimonialsContent>
            <TestimonialDescription><strong>"I've Been Working</strong> With Casey Exclusively Since 2014 And It Has Been Great! He Works Fast And Consistently Delivers High-Quality Work. He Takes My Vision And Translates It Into A <strong>Professional Design</strong> That Functions For My Business Goals. I've Really Appreciated How He's Always Focused On The Function Of The Piece As Well As The <strong>Visual Design.</strong>"</TestimonialDescription>
