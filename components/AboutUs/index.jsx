...
const AboutUs = () => {
  return (
    ...
    <About>
      ...
      <AboutBelow>
        <AboutContent>
          <AboutDescription>TALA is an entirely new type of fruit<br/> snack based on a simple yet revolutionary idea: make fruits snacks with real fruit, period</AboutDescription>
          <AboutQuote>ONE INGREDIENT <br/>ONE UNBELIVABLE CRUNCH</AboutQuote>
